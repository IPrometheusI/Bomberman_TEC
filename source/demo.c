...
struct game_element_t monsters[5];
...
init_game(&player, map_elements, NUM_MAP_ELEMENTS, lista_destructibles, NUM_DESTRUCTIBLES, monsters, &bomb_object, &explosion_object);
